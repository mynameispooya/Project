...
if uploaded_master and uploaded_attendance:
    ...
    try:
        ...
        for idx, row in df_raw.iterrows():
            # تبدیل کل ردیف به رشته برای جلوگیری از خطای float
        ...
        for r1, r2 in zip(row1, row2):
            # تمیزکاری متون ناخواسته ناشی از نال بودن سلول‌ها
            r1_clean = "" if r1 in ['nan', 'None', 'NaN'] else r1
            r2_clean = "" if r2 in ['nan', 'None', 'NaN'] else r2
            
            # منطق هوشمند استخراج نام ستون‌ها و جلوگیری از تداخل انواع داده
